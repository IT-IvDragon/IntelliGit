type MessageKey =
    ...
    | "label.branch"
    | "label.stash"
    | "label.searchBranches"
    | "label.close"
    | "label.groupFilesByDirectoryShort"
    | "label.changes"
    | "label.unversionedFiles";
...
const englishStrings: Record<MessageKey, string> = {
    ...
    "label.commitTab": "Commit",
    "label.shelfTab": "Stash",
    "label.changesTab": "Changes",
    "label.author": "Author",
    "label.date": "Date",
    "label.allBranches": "All branches",
    "label.textOrHash": "Text or hash",
    "label.clear": "Clear",
    "label.branch": "Branch",
    "label.stash": "Stash",
    "label.searchBranches": "Search branches",
    "label.groupFilesByDirectoryShort": "Group files by directory",
    "label.changes": "Changes",
    "label.unversionedFiles": "Unversioned Files",
};
...
const chineseStrings: Record<MessageKey, string> = {
    ...
    "label.author": "作者",
    "label.date": "日期",
    "label.allBranches": "所有分支",
    "label.textOrHash": "文本或哈希值",
    "label.clear": "清除",
    "label.branch": "分支",
    "label.stash": "暂存",
    "label.searchBranches": "搜索分支",
    "label.groupFilesByDirectoryShort": "按目录分组文件",
    "label.changes": "变更",
    "label.unversionedFiles": "未版本控制文件",
};
...
export function setLocale(locale: string): void {
    if (locale.startsWith("zh")) {
        currentLocale = locale === "zh-tw" || locale === "zh-hk" ? "zh" : "zh-cn";
    } else {
        currentLocale = "en";
    }
}
