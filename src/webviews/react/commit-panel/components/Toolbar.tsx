...
export function Toolbar({
    ...
    return (
        ...
        >
            ...
            <ToolbarButton
                label={isRefreshing ? localize("label.refreshing") : localize("label.refresh")}
                onClick={onRefresh}
                color="#4ec7d6"
                spin={isRefreshing}
            ...
            <ToolbarButton label={localize("label.rollback")} onClick={onRollback} color="#b8adff">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label={localize("label.groupByDirectory")} onClick={onToggleGroupBy} color="#efc09a">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label={localize("label.shelveChanges")} onClick={onShelve} color="#ea8fb3">
                <path
                    fill="currentColor"
            ...
            <ToolbarButton label={localize("label.showDiffPreview")} onClick={onShowDiff} color="#8fd5ff">
                <path
                    fill="currentColor"
            ...
            <Box flex={1} />
            <ToolbarButton label={localize("label.expandAll")} onClick={onExpandAll} color="#f3b1cf">
                <path
                    fill="currentColor"
                    fillRule="evenodd"
            ...
            <ToolbarButton label={localize("label.collapseAll")} onClick={onCollapseAll} color="#f3b1cf">
                <path
                    fill="currentColor"
                    fillRule="evenodd"
